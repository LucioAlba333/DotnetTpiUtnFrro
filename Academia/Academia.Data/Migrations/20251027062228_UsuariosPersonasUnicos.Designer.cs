...
namespace Academia.Data.Migrations
{
    ...
    [Migration("20251027062228_UsuariosPersonasUnicos")]
    partial class UsuariosPersonasUnicos
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Academia.Models.Comision", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Academia.Models.Curso", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Academia.Models.DocenteCursos", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Academia.Models.Curso", b =>
                {
                    b.HasOne("Academia.Models.Comision", "Comision")
                        .WithMany()
                        .HasForeignKey("IdComision")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Academia.Models.Materia", "Materia")
                        .WithMany()
            ...
            modelBuilder.Entity("Academia.Models.DocenteCursos", b =>
                {
                    b.HasOne("Academia.Models.Curso", "Curso")
                        .WithMany()
                        .HasForeignKey("IdCurso")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Academia.Models.Persona", "Docente")
                        .WithMany()
            ...
            modelBuilder.Entity("Academia.Models.Inscripcion", b =>
                {
                    b.HasOne("Academia.Models.Persona", "Alumno")
                        .WithMany()
            ...
            modelBuilder.Entity("Academia.Models.Usuario", b =>
                {
                    b.HasOne("Academia.Models.Persona", "Persona")
                        .WithOne()
                        .HasForeignKey("Academia.Models.Usuario", "IdPersona")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
